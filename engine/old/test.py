from general_settings import ACCESS_TOKEN
...
auth = tweepy.OAuthHandler(general_settings.CONSUMER_KEY, general_settings.CONSUMER_SECRET)
auth.set_access_token(general_settings.ACCESS_TOKEN, general_settings.ACCESS_SECRET)
